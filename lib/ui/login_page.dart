...
import 'dart:convert';
import 'package:gubuk_cinema/models/api_service_v2.dart';
...
class _Login extends State<Login> {
  ...
  Future<void> loginPostRequest() async {
    ...
    try {
      ...
      final dataLogin = await accountLogin(body);
      var response = await loginAccount(body);

      if (dataLogin.statusCode == 200) {
        final responseData = json.decode(dataLogin.body);
        ...
        if (null == responseData['message']) {
          ...
          await prefs.setStringList('user', [
            responseData['result'][0]['_id'],
            responseData['result'][0]['username'],
            responseData['result'][0]['fullname'],
            responseData['result'][0]['email'],
            responseData['result'][0]['password'],
          ]);
        }
      }
      ...
      if (response.statusCode == 200) {
        ...
        if (res['message'] == null) {
          ...
          List<String> jsonBookmarks = (mapJson['bookmark_movie'] as List)
